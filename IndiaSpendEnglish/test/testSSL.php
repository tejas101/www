...
<div id="page-header">
		<div class="page-wrap">
			<div class="logo-wrapper">
				<a href="http://www.indiaspend.com/"> <img height="32" width="81" src="images/India_Spend_Logo.png" alt="Citrus" />
				</a>
			</div>
		</div>
</div>
	...
	<form action="<?php echo $action;?>" method="POST"
		...
		<ul class="form-wrapper add-merchant clearfix">
			...
			<li class="clearfix"><input placeholder="First Name" class="text" name="firstName" type="text" value="" /></li>
			
			<li class="clearfix"><input placeholder="Last Name" class="text" name="lastName" type="text" value="" /></li>
			
			<li class="clearfix"> <input placeholder="Mobile Number" class="text" name="phoneNumber" type="text" value="" /></li>
			<li class="clearfix"><input placeholder="Address"  class="text" name="addressStreet1" type="text" value="" /></li>
			
			<li class="clearfix"> <input placeholder="City"  class="text" name="addressCity" type="text" value="" /></li>
			
			<li class="clearfix"><input placeholder="Pin Code:"  class="text" name="addressZip" type="text" value="" /></li>
			
			<li class="clearfix"> <input placeholder="State"  class="text" name="addressState" type="text" value="" /></li>		
			<li class="clearfix"><input placeholder="Country"  class="text" name="addressCountry" type="text" value="" /></li>		
			
			<li class="clearfix"><input placeholder="Email"  class="text" name="email" type="text" value="" />
			</li>
		...
		<!-- COD section END -->
			...
			<li class="clearfix"> 
				...
				<div class="cvv-no">
					...
					<input class="text cvv-text" name="cvvNumber" type="text" value="" />	</div>
			</li>
		...
		<div class="column2">
			<li class="clearfix"> <!--label width="125px;">Return Url:</label--><input class="text" name="returnUrl" type="hidden" value="http://www.indiaspend.com/test/Response.php" /></li>
		
			<li class="clearfix"> <p style="font-size:16px;">Donation Amount:</p>
				...
				<label class="amnt-btn"><span style="font-family:rupee;font-size:22px">R</span> <input placeholder="" onclick="clear_radio_buttons();" class="text" id="amount_other_field" name="orderAmount" type="text" value="" /></label>
			</li>
			<li class="clearfix">
				<p><input type="checkbox" id="honoree-box"/>Donate in someone's honor.</p>
				<div id="honoree-detailsss">
					<ul>
						<li class="honoree">
