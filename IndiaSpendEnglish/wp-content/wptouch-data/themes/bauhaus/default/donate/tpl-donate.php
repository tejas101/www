...
<div id="container">
		...
		<ul class="form-wrapper add-merchant clearfix">
			...
			<li class="clearfix"><p id="label_info">&nbsp;&nbsp;Your Info :</p></li>
        ...
        <div id="col2">
			...
			<li class="clearfix" > <p >&nbsp;&nbsp;Donation Amount :</p>
				<label class="amnt-btn"><input class="text amount_radio_button" type="radio" name="orderAmount" value="250" /><span style="font-family:rupee;font-size:22px">R </span> 250</label>
                ...
                <label class="amnt-btn"><input onClick="clear_other();" class="text amount_radio_button" type="radio" name="orderAmount" value="1000" /><span style="font-family:rupee;font-size:22px">R </span> 2000</label>
                <label class="amnt-btn"><input onClick="clear_other();" class="text amount_radio_button" type="radio" name="orderAmount" value="1000" /><span style="font-family:rupee;font-size:22px">R </span> 3000</label>
