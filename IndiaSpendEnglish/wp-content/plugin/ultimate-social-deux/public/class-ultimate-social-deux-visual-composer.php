...
if ( defined('WPB_VC_VERSION') ) {
	vc_map(
		array(
			...
			"base" => "ultimatesocial_fan_counts",
			...
			"params" => array(
				array(
					...
					"description" => __("Comma seperate a list of networks you would like to display. Setup is done from the Ultimate Social Deux settings menu. Available networks is:", "ultimate-social-deux") . ' ' . 'facebook, twitter, google, linkedin, youtube, vimeo, behance, soundcloud, dribbble, github, envato, delicious, instagram, vkontakte, pinterest, flickr, mailchimp, feedpress, love, members, posts, comments',
					"param_name" => "networks",
				),
				array(
					"type" => "dropdown",
				...
				array(
					"type" => "dropdown",
					"heading" => __("Skin", "ultimate-social-deux"),
					"param_name" => "skin",
					"value" => array_flip( UltimateSocialDeux::skins_array() )
				),
			)
		)
	);
