;(function ( $, window, document, undefined ) {
	...
	Plugin.prototype.renderer = function () {
		...
		if(template !== ''){  //if there is a template
		   if(total<2){   //alert('in if')	;
		  var intIndex = template.indexOf("us-icon-twitter");
		  var intIndex1 = template.indexOf("us-icon-linkedin");
		  var intIndex2 = template.indexOf("us-icon-facebook");
	  if(!(intIndex == - 1)){
	  ...
	  template = template.replace('{total}', total);
	   ...
	   {var template = '<div class="us_box" style="display: none;"><div class="us_count">{total}</div><div class="us_share"></div></div>';
      //alert('hi')	;   
	   }   }
...
jQuery(document).ready(function() {
		...
		jQuery('.us_total').each(function() {         
				...
				//alert(a);
		//if(a=='1')
			var template = '<div class="us_box"><div class="us_count" style="margin-top: -11px;font-size: 18px;margin-left: 13px;">{total}</div><div class="us_share" style="margin-left: -38px;font-size: 10px;" >' + us_script.total_shares_text + '</div></div><div class="slash"></div>';
		...
		jQuery('.us_twitter').each(function() {
			...
			if (jQuery(this).hasClass('us_native') ) {
				...
				var template = '<div class="us_share"><i class="us-icon-twitter"></i></div><div class="us_count">{total}</div>';
