...
<div id="primarycontent">
		...
		<!-- code to add the fellowship image -->
		<div class="fellowship" >
		<a href="http://www.indiaspend.com/fellowship"  target="_blank">
<img src="http://www.indiaspend.com/wp-content/uploads/fel_ship.jpg"  >
</a> </div>
	...
	<script id="mNCC" language="javascript">  medianet_width='300';  medianet_height= '250';  medianet_crid='621660518';  </script>  
		<script id="mNSC" src="http://contextual.media.net/nmedianet.js?cid=8CU5Z545Q" language="javascript"></script> 
            ...
            <a  href="http://www.indiaspend.com/category/prime-time-indias-grand-challenges">
			<p id="read"> Read More on Prime Time: India's Grand Challenges</p> </a>
...
<div id="secondarycontent">
	...
	<div id="secondary-mid">
		...
		<a  href="http://www.indiaspend.com/category/modis-message-indias-states-reply">
			<p id="read_mid"> Read More on Modi's Message: India's States Reply</p> </a>
	</div><!-- #secondary-left -->
