...
<link href="<?php echo get_template_directory_uri(); ?>/donate/css/donate.css" rel="stylesheet" type="text/css">
...
<div id="container">
			...
			<div id="banner"  align="center"><img src="<?php echo get_template_directory_uri(); ?>/donate/images/donate2.jpg" style="width:1024px height:347px"></div>
<div id="green"  align="center"><img src="<?php echo get_template_directory_uri(); ?>/donate/images/donate3.jpg" style="width:1024px height:124px"></div>  
		...
		<ul class="form-wrapper add-merchant clearfix">
			...
			<li class="clearfix" style="display:none;"><p id="label_info">&nbsp;&nbsp;Your Info :</p></li>
			<li class="clearfix col-3"><input class="text" placeholder="First Name" name="firstName" type="text" required /></li>
			
			<li class="clearfix col-3"><input class="text" placeholder="Last Name" id="lastName" name="lastName" type="text" required /></li>
			
			<li class="clearfix col-3"> <input class="text" placeholder="Mobile Number" name="phoneNumber" type="tel" required /></li>
			
			<li class="clearfix col-3"><input class="text" placeholder="Address"  name="addressStreet1" type="text"  required /></li>
			
			<li class="clearfix col-3"> <input class="text" placeholder="City"  name="addressCity" type="text" required /></li>
			
			<li class="clearfix col-3"><input class="text" placeholder="Pin Code"  name="addressZip" type="text" required /></li>
			
			<li class="clearfix col-3"> <input class="text" placeholder="State"  name="addressState" type="text" required /></li>		
			
			<li class="clearfix col-3"><input class="text" placeholder="Country"  name="addressCountry" type="text" required /></li>		
			
			<li class="clearfix col-3"><input class="text" placeholder="Email"  name="email" type="email" required />
			</li>
		...
		<div class="column2" id="column_2">
        <div id="col2">
			<li class="clearfix"> <!--label width="125px;">Return Url:</label--><input class="text" name="returnUrl" type="hidden" value="http://www.indiaspend.com/payment-response" /></li>
		
			<li class="clearfix" > <p>&nbsp;&nbsp;Donation Amount :</p>
                ...
                <label class="amnt-btn"><input onClick="clear_other();" class="text amount_radio_button" type="radio" name="orderAmount" value="2000" /><span style="font-family:rupee;font-size:22px">R </span> 2000</label>
                <label class="amnt-btn"><input onClick="clear_other();" class="text amount_radio_button" type="radio" name="orderAmount" value="3000" /><span style="font-family:rupee;font-size:22px">R </span> 3000</label>
			...
			<!--li class="clearfix">
				...
				<div id="honoree-detail">
					...
					<input type="submit" id="submit_columns" name="submit" class="btn-orange" value="Submit Donation"  /> <input id="reset_columns"
