...
<title><?php gab_title(); ?></title>
	...
	<script type="text/javascript" src="/wp-content/themes/advanced-newspaper/jquery.min.js"></script>
	<script type="text/javascript" src="/wp-content/themes/advanced-newspaper/imtech_pager.js"></script>
	<?php
...
$(document).ready(function(){
    $("#flip_praveen").click(function(){
        $("#panel_praveen").slideToggle("slow");
    });
});

$(document).ready(function(){
    $("#flip_kumaar").click(function(){
        $("#panel_kumaar").slideToggle("slow");
    });
});
...
<?php if (is_single( '11001' ) ) : ?>
<link rel="standout" href="http://www.indiaspend.com/cover-story/a-simple-believable-formula-for-predicting-general-elections-2014-201444"/>
<?php endif; ?>
</head>
	...
	<div id="masthead">
		<ul class="mastheadnav dropdown">
			...
			if(of_get_option('of_nav1', 0) == 1) { 
				...
				<li><a class="show" href="#sconnected" id="clicksconnected"><?php _e('Stay Connected', 'advanced'); ?></a></li>	<li>  <div class="slash" style="height: 15px;" ></div>	</li>					<?php mailchimpSF_signup_form(); ?>				
			<?php } ?>
		</ul>
		<div class="hide">
			<div id="sconnected"> 
			...
			<!-- MK Splash issue  -->
			<?php if ( is_active_widget( false, false, 'wpb_widget', true ) ) : 
			else : ?>
			</div>
		</div> 
		<?php endif; ?>
